# AsRock X99 Extreme/Taichi Opencore (Monterey - Sonoma)
...
---
> ⚠ **ADVICE** ⚠: I'm working for fix USB 2.0 ports on Ventura for now, maybe I'll try update Opencore for run Sonoma and Sequoia later.
---
